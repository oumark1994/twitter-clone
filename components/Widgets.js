...
<img className="rouded-full" width="40" src={randomUser.picture.thumbnail}/>
        ...
        <button onClick={()=>setRandomUserNum(randomUserNum + 3)} className="text-blue-300 pl-4">Show more </button>
    </div>
    </div>
  )
}
